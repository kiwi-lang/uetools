...
class Disable(Command):
    ...
    def arguments(subparsers):
        disable = subparsers.add_parser(Disable.name, help='Install Gamekit in a unreal project')
    ...
    def execute(args):
        ...
        with open(uproject, 'r') as project_file:
        ...
        with open(uproject, 'w') as project_file:
