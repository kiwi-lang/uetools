...
class BuildCookRunArgs:
    ...
    stagingdirectory        : str | None     = None  # Directory to copy the builds to, i.e. -stagingdirectory=C:/Stage
    unrealexe               : str | None     = None  # Name of the Unreal Editor executable, i.e. -unrealexe=UnrealEditor.exe
    archivedirectory        : str | None     = None  # Directory to archive the builds to, i.e. -archivedirectory=C:/Archive
    cmdline                 : str | None     = None  # command line to put into the stage in UECSCommandLine.txt
    bundlename              : str | None     = None  # string to use as the bundle name when deploying to mobile device
    map                     : str | None     = None  # map to run the game with
    AdditionalServerMapParams: str | None    = None  # Additional server map params, i.e ?param=value
    numclients              : int | None     = None  # Start extra clients, n should be 2 or more
    addcmdline              : str | None     = None  # Additional command line arguments for the program
    servercmdline           : str | None     = None  # Additional command line arguments for the program
    clientcmdline           : str | None     = None  # Override command line arguments to pass to the client
    Crash                   : int | None     = None  # when running -editortest or a client, adds commands like debug crash, debug rendercrash, etc based on index
    deviceuser              : str | None     = None  # Linux username for unattended key genereation
    devicepass              : str | None     = None  # Linux password
    RunTimeoutSeconds       : float | None   = None  # timeout to wait after we lunch the game
    SpecifiedArchitecture   : str | None     = None  # Determine a specific Minimum OS
    UbtArgs                 : str | None     = None  # extra options to pass to ubt
    MapsToRebuildLightMaps  : str | None     = None  # List of maps that need light maps rebuilding
    MapsToRebuildHLODMaps   : str | None     = None  # List of maps that need HLOD rebuilding
...
class LocalizeArgs:
    ...
    """
    UEProjectRoot                   : str | None  = None   # Optional root-path to the project we're gathering for (defaults to CmdEnv.LocalRoot if unset).",
    UEProjectDirectory              : str | None  = None   # Sub-path to the project we're gathering for (relative to UEProjectRoot).",
    UEProjectName                   : str | None  = None   # Optional name of the project we're gathering for (should match its .uproject file, eg QAGame).",
    LocalizationProjectNames        : str | None  = None   # Comma separated list of the projects to gather text from.",
    LocalizationBranch              : str | None  = None   # Optional suffix to use when uploading the new data to the localization provider.",
    LocalizationProvider            : str | None  = None   # Optional localization provide override."),
    LocalizationSteps               : str | None  = None   # Optional comma separated list of localization steps to perform [Download, Gather, Import, Export, Compile, GenerateReports, Upload] (default is all). Only valid for projects using a modular config.",
    ...
    ExcludePlugins                  : str | None  = None   # Optional comma separated list of plugins to exclude from the gather.",
    ...
    AdditionalCSCommandletArguments : str | None  = None   # Optional arguments to pass to the gather process.",
...
class UAT(Command):
    ...
    def arguments(subparsers):
        ...
        add_arguments(parser, LocalizeArgs)
        add_arguments(parser, BuildEditorArgs)
        add_arguments(parser, BuildCookRunArgs)
        add_arguments(parser, UATArgs)
