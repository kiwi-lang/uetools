...
class DevArguments:
    ...
    abslog                  : Optional[str]  = None  #  Same as LOG= but without a filename length check.
    ...
    log                     : Optional[str]  = None  #  When used as a switch (-log), opens a separate window to display the contents of the log in real time. When used as a setting (LOG=filename.log), tells the engine to use the log filename of the string that immediately follows.
...
class RenderingArguments:
    """Rendering arguments"""
    consolex                : Optional[int]   = None  #  Set the horizontal position for console output window.
    consoley                : Optional[int]   = None  #  Set the vertical position for console output window.
    winx                    : Optional[int]   = None  #  Set the horizontal position of the game window on the screen.
    winy                    : Optional[int]   = None  #  Set the vertical position of the game window on the screen.
    resx                    : Optional[int]   = None  #  Set horizontal resolution for game window.
    resy                    : Optional[int]   = None  #  Set vertical resolution for game window.
    vsync                   : Optional[bool]  = None  #  Activate the VSYNC via command line. Pprevents tearing of the image but costs fps and causes input latency.)
    novsync                 : Optional[bool]  = None  #  Deactivate the VSYNC via command line.
    benchmark               : Optional[bool]  = None  #  Run game at fixed-step in order to process each frame without skipping any frames. This is useful in conjunction with DUMPMOVIE options.
    dumpmovie               : Optional[bool]  = None  #  Dump rendered frames to files using current resolution of game.
    exec                    : Optional[str]   = None  #  Executes the specified exec file.
    fps                     : Optional[int]   = None  #  Set the frames per second for benchmarking.
    fullscreen              : Optional[bool]  = None  #  Set game to run in fullscreen mode.
    seconds                 : Optional[float] = None  #  Set the maximum tick time.
    windowed                : Optional[bool]  = None  #  Set game to run in windowed mode.
...
class NetworkArguments:
    ...
    port                : Optional[int]  = None  #  Tell the engine to use a specific port number.
...
class UserArguments:
    ...
    paths               : Optional[str]  = None  #  Set what paths to use for testing wrangled content. Not used for shipping releases.
...
class ConfigArguments:
    ...
    defeditorini            : Optional[str] = None  #  Set the default editor .ini file to use.
    editorini               : Optional[str] = None  #  Set the editor .ini file to use.
    defeditorusersettingsini: Optional[str] = None  #  Set the default editor user settings .ini file to use.
    editorusersettingsini   : Optional[str] = None  #  Set the editor user settings .ini file to use.
    defcompatini            : Optional[str] = None  #  Set the default  compatibility .ini file to use.
    compatini               : Optional[str] = None  #  Set the compatibility .ini file to use.
    deflightmassini         : Optional[str] = None  #  Set the default  lightmass .ini file to use.
    lightmassini            : Optional[str] = None  #  Set the lightmass .ini file to use.
    defengineini            : Optional[str] = None  #  Set the default  engine .ini file to use.
    engineini               : Optional[str] = None  #  Set the engine .ini file to use.
    defgameini              : Optional[str] = None  #  Set the default  game .ini file to use.
    gameini                 : Optional[str] = None  #  Set the game .ini file to use.
    definputini             : Optional[str] = None  #  Set the default  input .ini file to use.
    inputini                : Optional[str] = None  #  Set the input .ini file to use.
    defuiini                : Optional[str] = None  #  Set the default  UI .ini file to use.
    uiini                   : Optional[str] = None  #  Set the UI .ini file to use.


@dataclass
class DebugArguments:
    """Debugging arguments"""
    bugloc          : Optional[Vector]   = None  #  (e.g. BugLoc=(X=1798.8569,Y=475.9513,Z=-8.8500))
    bugrot          : Optional[Rotation] = None  #  (e.g. BugRot=(Pitch=-1978,Yaw=-7197,Roll=0))


@dataclass
class MiscArguments:
    """Other arguments"""
    timelimit       : Optional[float] = None  #  (e.g. timelimit=[time])
    goalscore       : Optional[float] = None  #  (e.g. goalscore=[score])
    numbots         : Optional[int]   = None  #  (e.g. numbots=[num])
