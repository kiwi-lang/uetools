...
def test_local(project, project_name):
    assert os.path.exists(os.path.join(project, "Config/Localization/ExampleProject.ini")) is False
    ...
    assert os.path.exists(os.path.join(project, "Config/Localization/ExampleProject.ini")) is True
