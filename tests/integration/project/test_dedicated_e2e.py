...
def test_dedicated_e2e(project, project_name):
    assert os.path.exists(os.path.join(project, "Source/ExampleProjectServer.Target.cs")) is False

    # Add a new dedicated server target
    main(args("project", "dedicated", project_name))

    assert os.path.exists(os.path.join(project, "Source/ExampleProjectServer.Target.cs")) is True
    ...
    assert os.path.exists(os.path.join(project, "Binaries/Win64/ExampleProjectServer.exe")) is False
    ...
    assert os.path.exists(os.path.join(project, "Binaries/Win64/ExampleProjectServer.exe")) is True
